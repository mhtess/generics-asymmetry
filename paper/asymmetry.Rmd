...
To replicate the asymmetry findings, we must also measure the truth conditions ratings, using an endorsement task. Here, we replicate the truth conditions task using the (slightly expanded) stimulus set of @Cimpian2010.
Recall that the prevalence priors have already been measured in Chapter 2 (Expt. 1A).
